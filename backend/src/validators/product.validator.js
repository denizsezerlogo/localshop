...
export const createRules = [
  ...
  body('category').trim().toLowerCase().isIn(CATEGORIES).withMessage(vt('VAL_CATEGORY')),
];
...
export const updateRules = [
  ...
  body('category').optional().trim().toLowerCase().isIn(CATEGORIES).withMessage(vt('VAL_CATEGORY')),
];
